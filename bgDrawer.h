...
void drawTextureQuad() {
	...
	glBegin(GL_QUADS);
	glTexCoord2f(0.0, 0.0); glVertex3f(-5, -5.0, -15.0);
	glTexCoord2f(0.0, 1.0); glVertex3f(-5.0, 5.0, -15.0);
	glTexCoord2f(1.0, 1.0); glVertex3f(5.0, 5.0, -15.0);
	glTexCoord2f(1.0, 0.0); glVertex3f(5.0, -5.0, -15.0);
	glEnd();
